...
df.csv: AAMR + EQI + RUCC-stratified EQI + all covariates (period-matched)
...
def main():
    ...
    for fp in aamr_files:
        ...
        if not year_range:
            ...
            continue
        dfs = _process_aamr_file(fp, year_range, icd_code, eqi_dict,
    ...
    out = out.sort_values(["Time_Period", "Outcome", "Lag_Years", "COUNTY_FIPS"]).reset_index(drop=True)
