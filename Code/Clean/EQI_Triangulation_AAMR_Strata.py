...
# All NDD ICD codes
NDD_ALL_CODES = ["G20_G30_G12.2_F01_F03", "G30_F01_F03", "G30", "G20", "F01", "G10", "G12.2"]
...
def get_top5_cancers(df: pd.DataFrame, time_period: str = "2006-2010") -> List[str]:
    ...
    # Exclude All-site Cancer and all NDD-related outcomes
    cancer_exclude = ["C00_C97", "G20_G30_G12.2_F01_F03", "G30_F01_F03"]
...
def get_top5_ndd(df: pd.DataFrame, time_period: str = "2006-2010") -> List[str]:
    ...
    # Include Dementia composite + individual NDD codes (exclude UD as it is in composite)
    ndd_codes = ["G30_F01_F03", "G10", "G12.2", "G20", "G30", "F01"]
