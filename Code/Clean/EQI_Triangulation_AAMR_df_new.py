...
OUTPUT_FILE = OUTPUT_DIR / "df_Main.csv"
SENSITIVITY_FILE = OUTPUT_DIR / "df_Sensitivity.csv"
...
def _get_valid_lag_combinations(time_period: str) -> list[tuple[int, str, str]]:
    ...
    4. EQI 2000-2005 (code '0005') + 20 years lag -> AAMR 2021-2024
    5. EQI 2006-2010 (code '0610') + 5 years lag -> AAMR 2011-2015
    6. EQI 2006-2010 (code '0610') + 10 years lag -> AAMR 2016-2020
    7. EQI 2006-2010 (code '0610') + 15 years lag -> AAMR 2021-2024
    ...
    if time_period == "2006-2010":
        ...
        # 2000-2005 EQI with 20 years lag AND 2006-2010 EQI with 15 years lag
        combinations.append((20, "0005", "2000-2005"))
        combinations.append((15, "0610", "2006-2010"))
...
def main():
    ...
    print("\n📊 Loading EQI, Smoking, Cluster, Climate, Typology, and sensitivity covariates...")
    ...
    numeric_climate_cols = ["census_region"]
    ...
    final = final.sort_values(
        ["Time_Period", "Outcome", "Lag_Years", "COUNTY_FIPS"]
    ...
    print(f"Cancer types:      {final['Outcome'].nunique()}")
