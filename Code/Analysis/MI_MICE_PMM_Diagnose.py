...
class SimpleMICEDiagnostician:
    ...
    def __init__(self, final_dataset: pd.DataFrame, 
        ...
        if output_dir is None:
            output_dir = Path(__file__).resolve().parents[2] / "Result" / "EQI_LMM_MI_Diagnose"
...
def main():
    ...
    try:
        ...
        original_path = project_root / "Data" / "df" / "EQI_LMM_MI_df.csv"
        final_path = project_root / "Data" / "df" / "EQI_LMM_MI_Imputed.csv"
