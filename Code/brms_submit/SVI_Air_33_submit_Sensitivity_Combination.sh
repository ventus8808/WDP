#!/bin/bash
# Slurm array launcher for the EQI-Air × SVI 3x3 joint sensitivity combination.
...
# Usage:
#   bash Code/brms_submit/SVI_Air_33_submit_Sensitivity_Combination.sh

#SBATCH --partition=wzhctest
#SBATCH --job-name=brms_SVI_Air_33_Sensitivity_Combination
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=6
#SBATCH --mem=18G
#SBATCH --time=2-00:00:00
#SBATCH --output=SVI_Air_33_Sensitivity_Combination_%A_%a.out
#SBATCH --error=SVI_Air_33_Sensitivity_Combination_%A_%a.err
...
RUNNER="Code/brms/SVI_Air_33_brms_Sensitivity_Combination.R"
