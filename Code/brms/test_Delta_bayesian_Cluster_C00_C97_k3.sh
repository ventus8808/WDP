#!/bin/bash
# Test script for Delta_bayesian_Cluster analysis - C00_C97 with k=3
# Usage: bash Code/brms/test_Delta_bayesian_Cluster_C00_C97_k3.sh
...
#SBATCH --output=test_Delta_bayesian_Cluster_C00_C97_k3_%j.out
#SBATCH --error=test_Delta_bayesian_Cluster_C00_C97_k3_%j.err
...
log INFO "开始测试: Delta_bayesian_Cluster C00_C97 with k=3"
...
# Run the Delta_bayesian_Cluster analysis for C00_C97 with k=3
Rscript "$RUNNER" \
...
log INFO "✅ 测试完成: Delta_bayesian_Cluster C00_C97_k3"