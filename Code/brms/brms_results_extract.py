...
top5_files = ['C00_C97_brms.csv', 'C34_brms.csv', 'C18_C21_brms.csv', 'C50_brms.csv', 'C61_brms.csv']

# Get all brms files
all_files = [f for f in os.listdir(result_dir) if f.endswith('_brms.csv')]

# Mapping of ICD_Code to names (English)
icd_mapping = {
    'C00_C97': 'All Malignant Neoplasms',
    'C15_C26': 'Digestive System',
    'C18_C21': 'Colorectal Cancer',
    'C25': 'Pancreatic Cancer',
    'C30_C39': 'Respiratory System and Intrathoracic Organs',
    'C34': 'Lung and Bronchus Cancer',
    'C40_C41': 'Bone and Articular Cartilage',
    'C43_C44': 'Skin',
    'C45_C49': 'Mesothelial and Soft Tissue',
    'C50': 'Breast Cancer',
    'C51_C58': 'Female Genital Organs',
    'C60_C63': 'Male Genital Organs',
    'C61': 'Prostate Cancer',
    'C64_C68': 'Urinary Tract',
    'C69_C72': 'Eye, Brain and Other Central Nervous System',
    'C73_C75': 'Thyroid and Other Endocrine Glands',
    'C76_C80': 'Ill-defined, Secondary and Unspecified Sites',
    'C81_C96': 'Lymphoid, Hematopoietic and Related Tissue',
    'C97': 'Independent (Primary) Multiple Sites',
    # Specific cancer types
    'C22': 'Liver and Intrahepatic Bile Duct Cancer',
    'C64': 'Kidney Cancer',
    'C67': 'Bladder Cancer',
...
def process_files(files, output_name, period='2000_2005'):
    ...
    if dfs:
        ...
        # Sort by ICD_Code, EQI_Period, Lag
...
if dfs_top5:
    ...
    combined_top5 = combined_top5.sort_values(by=['ICD_Code', 'EQI_Period', 'Lag'])
