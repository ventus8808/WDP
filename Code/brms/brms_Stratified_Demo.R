...
option_list <- list(
  make_option(c("--data"),          type = "character", default = "Data/Processed/df_Stratified.csv",  help = "Input data"),
  make_option(c("--output-dir"),    type = "character", default = "Result/brms_Stratified_Demo",       help = "Output directory"),
...
for (outcome in selected) {
  ...
  outfile <- file.path(out_dir, paste0(dlabel, "_Stratified_Demo.csv"))
