...
LAG_COLORS = {5: "#3F007D", 10: "#756BB1", 15: "#BCBDDC"}  # dark → mid → light purple
...
cbar.set_label("Mortality Rate Difference (MRD, per 100 000)", fontsize=11)
cbar.ax.tick_params(labelsize=9)

plt.savefig(
    OUT_DIR / "MRR_MRD_Forest.png", dpi=DPI, bbox_inches="tight", facecolor="white"
)
plt.savefig(OUT_DIR / "MRR_MRD_Forest.pdf", bbox_inches="tight", facecolor="white")
plt.close()
print("Saved → MRR_MRD_Forest_New.png / .pdf")
