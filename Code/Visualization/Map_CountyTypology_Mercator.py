...
def plot_county_typology_map(config):
    ...
    for contiguous US using an oblique Mercator projection.
    """
    print("Creating County Typology map (Mercator projection)...")
    ...
    # Save
    output_filename = os.path.join(output_dir, "County_Typology_2004_Mercator.png")
